...
const dodecahedronTruncData = (n) => {
    ...
    const f = (v) => [
        p * Math.sqrt(Math.abs(cot / (1 + p_4 / 4 - p_2 * cot / 5))) * v[0],
        Math.sqrt(Math.abs((cot - p_2) / (1 + p_4 / 4 - p_2 * cot / 5))) * v[1],
        Math.sqrt(Math.abs((cot - p_2) / (1 + p_4 / 4 - p_2 * cot / 5))) * v[2],
        Math.sqrt(Math.abs((cot - p_2) / (1 + p_4 / 4 - p_2 * cot / 5))) * v[3]
    ];
